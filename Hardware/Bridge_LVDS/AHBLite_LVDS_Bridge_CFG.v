`ifndef AHBLite_LVDS_Bridge_CFG
	...
	`define AHBLite_LVDS_Bridge_BASE_ADDR		32'h0000_0000
	...
	`define AHBLite_LVDS_BUFF_BASE_ADDR			(`AHBLite_LVDS_Bridge_BASE_ADDR + 4)
	`define AHBLite_LVDS_BUFF_END_ADDR			(`AHBLite_LVDS_Bridge_BASE_ADDR + 32'h1FFF)
`endif